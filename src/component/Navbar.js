        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-light">
                <div className="container">
                    ...
                    <NavLink className="h1 text-dark fs-4" to="/">
                        CORAL
                    </NavLink>
                    <svg width="31" height="15" viewBox="0 0 31 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.353554 7.5L7.5 0.353554L14.6464 7.5L7.5 14.6464L0.353554 7.5Z" stroke="black" stroke-width="0.5" />
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="bar navbar-nav mx-auto mb-2">
                            <li className="nav-item">
                                <NavLink className="nav-link active" aria-current="page" to="https://en.wikipedia.org/wiki/Home_page">Home</NavLink>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link" to="/sign">Address</NavLink>
                            </li>
                        ...
                        <div className='buttons'>
                            <NavLink onClick={increase} to="/cart" className='btn as m-2'>
